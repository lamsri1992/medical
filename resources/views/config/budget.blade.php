                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-secondary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">
                                    <i class="fa fa-notes-medical"></i> ข้อมูลงบประมาณ
                                </h6>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="tableBasic" class="table table-striped table-borderless compact">
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                class="text-secondary text-xxs font-weight-bolder">
        ...
        <form id="addType">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> เพิ่มข้อมูลงบประมาณ</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">ชื่องบประมาณ</label>
                        <input type="text" name="bname" class="form-control" required>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">ยอดเงินที่ได้รับจัดสรร</label>
                        <input type="text" name="btotal" class="form-control" required>
                    </div>
                </div>

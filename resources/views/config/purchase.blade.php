                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-secondary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">
                                    <i class="fa fa-file-invoice-dollar"></i> ข้อมูลวิธีการจัดซื้อ
                                </h6>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <form id="addData">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> เพิ่มข้อมูลวิธีการจัดซื้อ</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">ชื่อวิธีการจัดซื้อ</label>
...
<script>
        ...
        Swal.fire({
            title: 'บันทึกข้อมูลวิธีการจัดซื้อ ?',
